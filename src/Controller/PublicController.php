...
class PublicController extends AbstractController
{
    ...
    #[Route('/presentation/tarifs', name: 'presentation_tarifs')]
    public function presentationTarifs(): Response
    {
        return $this->render('public/presentation_tarifs.html.twig');
    }

    #[Route('/presentation/reseaux-sociaux', name: 'presentation_reseaux')]
    public function presentationReseaux(): Response
    {
        return $this->render('public/presentation_reseaux.html.twig');
    }
    ...
    public function checkoutAdminValidate(Request $request): Response
    {
        ...
        $commande->setReduction($reduction);
        $commande->setTotal(max(0.01, $cartTotal + $fraisLivraison - $reduction));
        $commande->setModePaiement('admin');
        $commande->setNotes($data['notes'] ?? null);
        $commande->setStatut('payee');
        if ($this->getUser() instanceof User) {
            $commande->setUser($this->getUser());
